...
export function TopBar({
  ...
  return (
    ...
    >
      ...
      >
        <span className="hidden truncate text-[12.5px] text-[var(--ink-3)] sm:block">
          {current.group}
        </span>
        <ChevronRight
          aria-hidden
      ...
      <span className="hidden h-7 shrink-0 items-center gap-1.5 rounded-[6px] border border-[var(--line)] bg-[var(--elevated)] px-2 text-[11.5px] text-[var(--ink-2)] md:inline-flex">
      ...
      <div className="ml-auto flex shrink-0 items-center gap-1">
        ...
        >
          ...
          <kbd className="tnum ml-auto shrink-0 rounded-[4px] border border-[var(--line)] bg-[var(--card)] px-1 py-px text-[10px] leading-[1.6] text-[var(--ink-4)]">
            ⌘K
          </kbd>
        </button>
