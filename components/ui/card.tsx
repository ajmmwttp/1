...
/**
 * Surface primitive. Depth comes from a hairline and a surface step,
 * not from blur — shadows stay near-invisible on purpose.
 */
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "relative rounded-[12px] border border-[var(--line)] bg-[var(--card)] shadow-[var(--shadow-flat)]",
      className,
    )}
    {...props}
  />
